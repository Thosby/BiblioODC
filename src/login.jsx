      ...
      <div class="flex h-screen">
        ...
        <div class="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
          <div class="max-w-md w-full p-6">
            ...
            <h1 class="text-3xl font-semibold mb-3 text-black text-center mt-12">
              inscription
            </h1>
            <h1 class="text-sm font-semibold mb-3 text-gray-500 text-center">
              Rejoignez notre communauté avec un accès permanent et gratuit
            </h1>
            ...
            <form onSubmit={handleform} class="space-y-4" ref={formRef}>
              ...
              <div>
                ...
                <input
                  ...
                  class="mt-1 p-2 w-full bg-grey-200 text-dark-grey-900 border rounded-md focus:border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300 transition-colors duration-300"
                />
              </div>
              <div>
                <label
            ...
            <div class="mt-4 text-sm text-gray-600 text-center mb-12">
              <p>
